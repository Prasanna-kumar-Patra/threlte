...
declare module '$env/static/private' {
	...
	export const CC_aarch64_linux_android: string;
	...
	export const CARGO_TARGET_AARCH64_LINUX_ANDROID_LINKER: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NVM_DIR: string;
		COMMAND_MODE: string;
		CC_aarch64_linux_android: string;
		...
		PATH: string;
		CARGO_TARGET_AARCH64_LINUX_ANDROID_LINKER: string;
